...
//
        ...
        TextView prases = findViewById(R.id.phrases);
        prases.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MainActivity.this , PrasesActivity.class);
                startActivity(i);
            }
        });
    }
...
//    TextView number = new TextView(R.id.numbers);



    public void opennumberactivity(View view){

//        String textMessage  = " hiii how r u?";
